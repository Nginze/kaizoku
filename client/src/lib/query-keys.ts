...
export const animeKeys = {
  ...
  featured: () => 
    [...animeKeys.all, "featured"] as const,
    
  recentReleases: () => 
    [...animeKeys.all, "recent-releases"] as const,
    
  schedule: () => 
    [...animeKeys.all, "schedule"] as const,
  ...
  // EPISODE SOURCES
  sources: () => 
    [...animeKeys.all, "sources"] as const,
    
  episodeSources: (animeId: string, epId: string, type: "SUB" | "DUB" = "SUB") => 
    [...animeKeys.sources(), "episode", { animeId, epId, type }] as const,
    
  episodeServers: (animeId: string, epId: string, type: "SUB" | "DUB" = "SUB") => 
    [...animeKeys.sources(), "servers", { animeId, epId, type }] as const,
    
  // INDIVIDUAL ANIME
  detail: (id: string) => 
    [...animeKeys.all, "detail", id] as const,
    
  episodes: (id: string) => 
    [...animeKeys.detail(id), "episodes"] as const,
    
  // UTILITY QUERIES
  filters: () => 
    [...animeKeys.all, "filters"] as const,
    
  genres: () => 
    [...animeKeys.filters(), "genres"] as const,
    
  tags: () => 
    [...animeKeys.filters(), "tags"] as const,
  ...
  invalidateSearch: () => 
    [...animeKeys.all, "search"],
    
  invalidatePopular: () => 
    [...animeKeys.all, "popular"],
    
  invalidateTopRated: () => 
    [...animeKeys.all, "top-rated"],
    
  invalidateTopAiring: () => 
    [...animeKeys.all, "top-airing"],
    
  invalidateUpcoming: () => 
    [...animeKeys.all, "upcoming"],
